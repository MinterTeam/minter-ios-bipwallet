...
open class SearchTextField: UITextField {
    ...
    open func filterStrings(_ strings: [String]) {
        ...
        for value in strings {
          items.append(SearchTextFieldItem(id: String.random(), title: value))
        }
...
//        indicator.stopAnimating()
    ...
    open var isScrollingEnabled: Bool = true
    ...
    fileprivate static let cellIdentifier = "SearchTextFieldCell"
...
//        self.rightView = indicator
    ...
    fileprivate func buildSearchTableView() {
        ...
        tableView.register(UINib(nibName: SearchTextField.cellIdentifier, bundle: nil), forCellReuseIdentifier: SearchTextField.cellIdentifier)
        ...
        shadowView.layer.applySketchShadow(color: UIColor.black, alpha: 1.0, x: 0.0, y: 2.0, blur: 20.0, spread: 0.0)
...
extension SearchTextField: UITableViewDelegate, UITableViewDataSource {
    ...
    public func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        if let configurableCell = cell as? SearchTextFieldCell {
          configurableCell.configure(with: filteredResults[(indexPath as NSIndexPath).row])
        }
...
open class SearchTextFieldItem {
  ...
  public init(id: String, title: String, subtitle: String?, image: UIImage? = nil, imageURL: URL? = nil) {
    self.id = id
    self.title = title
...
class SearchTextFieldCell: UITableViewCell {
  ...
  func configure(with item: SearchTextFieldItem) {
