...
//    UIApplication.shared.open(URL(string: "mintertestnet://bip.to/tx/8AOg34paT0xPVE8AAAAAik1OVAAAAAAAAACIDeC2s6dkAACAgAGKTU5UAAAAAAAAAA")!, options: [:], completionHandler: nil)
    //Buy
//    UIApplication.shared.open(URL(string: "mintertestnet://bip.to/tx/-DoEqumKWk9MT1RPAAAAAIgbwW1nTsgAAIpNTlQAAAAAAAAAiaKhXQlRm-AAAICAAYpNTlQAAAAAAAAA")!, options: [:], completionHandler: nil)
    //Delegate
